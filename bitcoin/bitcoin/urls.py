...
urlpatterns = [
    ...
    path('5/', dice_views.player, name='5'),
    path('3/', dice_views.player, name='3'),
    path('4/', dice_views.player, name='4'),
    path('6/', dice_views.player, name='6'),
    path('1/', dice_views.player, name='1'),
    path('2/', dice_views.player, name='2'),
